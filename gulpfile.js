...
const files = {
  ...
  sass: ['src/sass/**/*.scss'],
  css: ['dist/app.css'],
  clean: ['dist/funkmaster-flexgrid.css',
    'dist/funkmaster-flexgrid.min.css',
    'docs/css/funkmaster/funkmaster-flexgrid.css',
    'docs/css/funkmaster/funkmaster-flexgrid.min.css'
  ],
...
gulp.task('compileSass', function () {
  return gulp.src('./src/sass/main.scss')
    ...
    .pipe(rename('funkmaster-flexgrid.css'))
    .pipe(gulp.dest('./dist'))
    .pipe(gulp.dest('./docs/css/funkmaster'))
    .pipe(rename({
      suffix: '.min'
    }))
    .pipe(minify({
